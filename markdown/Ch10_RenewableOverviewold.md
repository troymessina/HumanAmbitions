...
- $\triangleright$  Waves (Chap. 16) bring energy to shorelines that can drive specialized generators to make electricity.
...
| tides               | 3          | (0.0018) | $\mathbb{C}$ , $\odot$           | gravitational; mostly from Moon, some from Sun             |
